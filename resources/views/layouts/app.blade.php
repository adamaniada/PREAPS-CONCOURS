...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-bs-theme="auto">
    <head>
        <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=M73YF66WOttqJFoM8uIVWkwA6H16oTpd9FIHtQAw_e3iOiaoT3PqCba1kz4eSNVRGL7n8cl6DdZp0biXV5Mjpg7oDHuNezhUcQ4rv6XFRc0" charset="UTF-8"></script>
        <script src="{{ asset('js/color-modes.js') }}"></script>

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="">
        <meta name="author" content="Adama NIADA">
        <meta name="generator" content="Adama 0.115.4">
    ...
    <body>
        ...
        <div class="container">
            @include('layouts.include.app.navbar')
        </div>
